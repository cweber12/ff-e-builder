...
- refactor(catalog): replace the catalog item dropdown with a thumbnail-first Catalog Navigator overlay that keeps Add to FF&E and Remove from FF&E as supporting actions
