...
export const CreateProposalItemSchema = z.object({
  ...
  footprint_label: z.string().max(255).default(''),
  footprint_w: z.string().max(50).default(''),
  footprint_d: z.string().max(50).default(''),
  footprint_unit: z.string().max(20).default(''),
  footprint_area: z.number().nonnegative().nullable().default(null),
...
export const UpdateRevisionItemCostSchema = z.object({
