...
- **Materials** — project-specific material libraries store swatches, IDs, descriptions, and images, then assign multiple materials to items and catalog pages. See [docs/materials.md](docs/materials.md).
