...
- **Materials** — project-specific material libraries store multiple swatches, IDs, descriptions, and images, then assign multiple materials to items from the library or Add Item drawer and catalog pages. See [docs/materials.md](docs/materials.md).
