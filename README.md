...
- **Project header and navigation** -- compact read-only project identity, a desktop left-rail project-tool nav with mobile tab fallback, and a right-sidebar toggle beside the user avatar for FF&E, Proposal, Plans, Materials, and Budget tools.
