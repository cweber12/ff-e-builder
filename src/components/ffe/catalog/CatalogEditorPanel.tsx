...
const CATALOG_EDITOR_TABS: Array<{ id: CatalogEditorTab; label: string }> = [
  ...
  { id: 'document-mark', label: 'Document Mark' },
];
...
export function CatalogEditorPanel({
  ...
  const [activeTab, setActiveTab] = useState<CatalogEditorTab>('text');
    ...
    >
      ...
      <div className="catalog-layout-popover-body">
        ...
        <div className="catalog-layout-panel">
          ...
          {activeTab === 'document-mark' ? (
            <>
              <div className="catalog-layout-tab-heading">
                <p className="catalog-layout-label">Document Mark</p>
                <button
                  type="button"
                ...
                >
                  ...
                  <div className="catalog-opacity-row">
                    ...
                    <input
                      ...
                      disabled={!isDocumentMarkEnabled}
                      onChange={(event) =>
                        onWatermarkChange({ opacity: Number(event.target.value) })
                      }
