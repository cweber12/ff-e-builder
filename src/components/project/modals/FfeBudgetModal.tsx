    ...
    <Modal open={open} onClose={onClose} title="FF&E Budget" className="max-w-4xl">
      <div className="flex flex-col" style={{ maxHeight: 'calc(90vh - 9rem)' }}>
        <div className="flex-1 overflow-y-auto space-y-5 pb-4">
          {/* Budget vs actual */}
          <section className="border border-neutral-200 bg-canvas-shell p-4">
            ...
            {hasBudget && (
              <div className="mt-3 h-2.5 overflow-hidden rounded-pill bg-neutral-100">
                <div
            ...
            {itemStatuses.map((status) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-3 text-xl font-semibold text-neutral-950">{entry.count}</p>
                  <p className="mt-0.5 text-xs text-neutral-500">
