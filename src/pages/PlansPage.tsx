      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1.45fr)_360px]">
        ...
        <aside className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
          ...
          <form className="mt-6 space-y-4" onSubmit={(event) => void handleSubmit(event)}>
            ...
            <label className="block">
              <span className="mb-1.5 block text-sm font-medium text-neutral-700">Plan source</span>
              <div className="rounded-2xl border border-dashed border-neutral-300 bg-neutral-50 p-4">
                ...
                <p className="mt-1 text-xs leading-5 text-neutral-400">
                  Images up to 10 MB, or PDFs up to 50 MB. PDF uploads create a Measured Plan from
                  the page you select below.
                </p>
            ...
            <Button type="submit" className="w-full" disabled={!canSubmit}>
              {createPlan.isPending || isPreparingPdf ? 'Uploading plan…' : 'Upload plan'}
            </Button>
          </form>
        </aside>
      </section>
